					...
					<c:forEach var="product" items="${list}">
						<tr id="product_id_1">
							<td class="thumb"><img
								...
								href="product-view.jsp">${product.name}</a></td>
							<td class="price" id="price_id_1"><span>￥${product.price}</span>
								<input type="hidden" value="${product.price}" /></td>
							<td class="number"><span name="del">-</span> <input
								id="number_id_1" type="text" name="number" value="1" /> <span
								name="add">+</span></td>
							<td class="delete"><a href="CartServlet?id=${product.id}&action=del">删除</a></td>
						</tr>
					</c:forEach>
				</table>
				<div class="total">
