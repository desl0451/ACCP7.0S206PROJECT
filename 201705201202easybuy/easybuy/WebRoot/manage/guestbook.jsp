...
<%@ page import="cn.easybuy.dao.impl.CommentDaoImpl"%>
<%@ page import="cn.easybuy.entity.Comment"%>
<%
		...
		<div id="menu-mng" class="lefter">
			<div class="box">
				<dl>
					...
					<dt>新闻管理</dt>
					<dd>
						<em><a href="manage/news-add.jsp">新增</a></em><a
							href="manage/news.jsp">新闻管理</a>
					</dd>
				</dl>
			</div>
		</div>
			...
			<div class="manage">
				<table class="list">
					...
					<%
					 ...
					 %>
					<tr>
						<td class="first w4 c"><%=c.getId() %></td>
						<td class="w1 c"><%=c.getNickName() %></td>
						<td><%=c.getContent() %></td>
						<td class="w1 c">
						<%
						...
						<td class="w1 c"><a href="guestbook-modify.jsp">修改</a> <a
							class="manageDel" href="javascript:void(0)">删除</a></td>
					</tr>
					<%
					} %>
				</table>
