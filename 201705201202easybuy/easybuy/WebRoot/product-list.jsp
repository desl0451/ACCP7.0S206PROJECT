...
<body>
	<div id="header" class="wrap">
		...
		<div class="help">
			<a href="shopping.jsp" class="shopping">购物车X件</a><a
			...
			<div class="product-list">
				...
				<ul class="product clearfix">
					<li>
						<dl>
							<dt>
								<a href="product-view.jsp" target="_self"><img
									src="images/product/1.jpg" /></a>
							</dt>
							<dd class="title">
								<a href="product-view.jsp" target="_self">法国德菲丝松露精品巧克力500g/盒</a>
							</dd>
					...
					<li>
						<dl>
							...
							<dd class="title">
								<a href="product-view.jsp" target="_self">乐扣普通型保鲜盒圣诞7件套</a>
							</dd>
					...
					<li>
						<dl>
							...
							<dd class="title">
								<a href="product-view.jsp" target="_self">欧珀莱均衡保湿四件套</a>
							</dd>
					...
					<li>
						<dl>
							...
							<dd class="title">
								<a href="product-view.jsp" target="_self">联想笔记本电脑 高速独立显存</a>
							</dd>
					...
					<li>
						<dl>
							...
							<dd class="title">
								<a href="product-view.jsp" target="_self">法姿韩版显瘦彩边时尚牛仔铅笔裤</a>
							</dd>
					...
					<li>
						<dl>
							...
							<dd class="title">
								<a href="product-view.jsp" target="_self">Genius925纯银施华洛世奇水晶吊坠</a>
							</dd>
							<dd class="price">￥69.90</dd>
						</dl>
					</li>
					<li>
						<dl>
							...
							<dd class="title">
								<a href="product-view.jsp" target="_self">利仁2018M福满堂电饼铛
									好用实惠</a>
							</dd>
					...
					<li>
						<dl>
							...
							<dd class="title">
								<a href="product-view.jsp" target="_self">达派高档拉杆箱20寸 经典款式</a>
							</dd>
					...
					<li>
						<dl>
							...
							<dd class="title">
								<a href="product-view.jsp" target="_self">爱国者MP4 全屏触摸多格式播放
									4G</a>
							</dd>
					...
					<li>
						<dl>
							...
							<dd class="title">
								<a href="product-view.jsp" target="_self">多美滋金装金盾3阶段幼儿配方奶粉</a>
							</dd>
